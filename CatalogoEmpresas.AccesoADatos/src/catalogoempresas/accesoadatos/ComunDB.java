...
public class ComunDB {
    ...
    public static Statement createStatement(Connection pConn) throws SQLException { // select * from contactos -> statement
        Statement statement = pConn.createStatement();
        return statement;
    }
    
    public static PreparedStatement createPreparedStatement(Connection pConn, String pSql) throws SQLException { // Insert into Rol (nombre) Values('Admin') -> PreparedStatement
